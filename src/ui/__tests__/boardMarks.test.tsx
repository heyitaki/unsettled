...
describe('board mark layer', () => {
  ...
  it('draws an edge mark as one stroke and no vertex circle', () => {
    draw([{ ref: EDGE, color: COLOR, label: 'R' }])
  ...
  it('ignores an edge mark the layout has no edge for', () => {
    draw([{ ref: 'e:9,9;9,10', color: COLOR, label: 'R' }])
